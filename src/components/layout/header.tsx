...
export function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    <header className="lg:hidden flex items-center justify-between p-4 bg-[var(--card-bg)] border-b-4 border-[var(--border-color)] backdrop-blur supports-[backdrop-filter]:bg-[var(--card-bg)]/95">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-lg font-black leading-tight">AEEG</h1>
